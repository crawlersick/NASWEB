...
uwsgi_python3 --http-socket 0.0.0.0:5000  --module hello --callable app --stats 127.0.0.1:9191 --master --processes 10 --threads 5 -d /tmp/uwsg.log --pidfile /tmp/uwsgipid
